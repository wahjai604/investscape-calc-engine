import { amortizationSchedule, remainingBalance, trancheAmortizationSchedule, AmortizingTranche } from "../src/amortization";
import { MortgageInput } from "../src/mortgage";
